      ...
      <main className="flex-grow pt-28 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Trắc nghiệm Thật/Giả</h1>
            <p className="text-gray-600 mb-8">Kiểm tra khả năng phân biệt website thật và website giả mạo của bạn.</p>
