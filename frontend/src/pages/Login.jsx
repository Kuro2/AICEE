      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-3xl border border-slate-700 p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 bg-slate-900/50 hover:bg-slate-900 border border-slate-700 text-white rounded-xl transition-all flex items-center justify-center space-x-3 text-sm">
